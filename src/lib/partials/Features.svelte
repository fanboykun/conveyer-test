        ...
        <div class="mt-16 sm:mt-20">
          ...
          >
            <li class="group relative flex flex-col items-start">
              ...
              >
                <div
                  class="absolute -inset-x-4 -inset-y-6 z-0 scale-95 bg-white/20 opacity-0 transition group-hover:scale-100 group-hover:opacity-100  sm:-inset-x-6 sm:rounded-2xl"
                />
              ...
              <p
                class="relative z-10 mt-6 flex text-sm font-medium text-zinc-400 transition group-hover:text-teal-500 "
              >
                <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
