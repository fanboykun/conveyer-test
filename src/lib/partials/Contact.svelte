<div class="sm:px-8 mt-12 md:mt-12">
  <div class="mx-auto max-w-7xl lg:px-8">
    <div class="mx-auto lg:col-span-2 pb-4">
      <header class="sm:px-4 px-6 lg:px-2 pb-8">
        <h1 class="text-4xl sm:text-5xl font-bold tracking-tight text-zinc-800">
          We Continue <span> Our Legacy </span>
        </h1>
      </header>
    </div>
    <div class="relative px-4 sm:px-2 lg:px-2 py-4">
      <div class="mx-auto max-w-2xl lg:min-w-full">
        <div
          class="mx-auto grid grid-cols-1 gap-y-20 lg:max-w-none lg:grid-cols-2"
        >
              ...
              <ol class="mt-6 space-y-4">
                <li class="flex gap-4">
                  ...
                  <dl class="flex flex-auto flex-wrap gap-x-2">
                    ...
                    <dt class="sr-only">Desc</dt>
                    <dd class="text-xs text-zinc-500">WhatsApp</dd>
                    <dd
                ...
                <li class="flex gap-4">
                  ...
                  <dl class="flex flex-auto flex-wrap gap-x-2">
                    ...
                    <dt class="sr-only">Desc</dt>
                    <dd class="text-xs text-zinc-500">Email</dd>
                    <dd
                      class="ml-auto text-xs text-zinc-400 dark:text-zinc-500"
                      aria-label="2019 until Present">
                ...
                <li class="flex gap-4">
                  ...
                  <dl class="flex flex-auto flex-wrap gap-x-2">
                    ...
                    <dt class="sr-only">Desc</dt>
                    <dd class="text-xs text-zinc-500">Instagram</dd>
                    <dd
                      class="ml-auto text-xs text-zinc-400 dark:text-zinc-500"
                      aria-label="2019 until Present">
                      <a href="https://www.instagram.com/aromezcandlebathco">Follow us on Instagram</a>
                    </dd>
                  </dl>
                </li>
              </ol>
