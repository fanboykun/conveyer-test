<footer aria-label="Site Footer" class="bg-white/25">
  <div class="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div class="flex justify-center text-slate-800 sm:justify-start">
          <h1 class="font-bold text-2xl">Aromez</h1>
        </div>
        ...
        <ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
          <li>
            <a
              ...
              rel="noreferrer"
              target="_blank"
              class="text-lilac-600 transition hover:text-fuchsia-700/75"
            >
      ...
      >
        ...
        <div class="text-center sm:text-left">
          ...
          <ul class="mt-8 space-y-4 text-sm">
            <li>
              <a
                class="flex items-center justify-center gap-1.5 text-lilac-600 hover:text-fuchsia-700/75"
                href="/"
              >
                <svg
    ...
    <div class="mt-12 border-t border-gray-100 pt-6">
      <div class="text-center sm:flex sm:justify-between sm:text-left">
        <p class="text-sm text-gray-500">
          <span class="block sm:inline">Photo by Freepik & Pexels.</span>
